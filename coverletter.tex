...
\name{Yi-Xi}{Chen}
\position{Software Engineer{\enskip\cdotp\enskip}Network Profession}
\address{Tainan, Taiwan}
\mobile{(+886) 910635509}
\email{chen.ishi@gmail.com}
\homepage{https://chenishi.github.io/}
\github{chenIshi}
\linkedin{yi-xi chen}
% \gitlab{gitlab-id}
...
\recipient
  {Netskope}{Company Recruitment Team}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% The title of the letter
\lettertitle{Job Application for Backend Engineer, Private Access}
